...
void loop()
{
  ...
  if (button1_State == HIGH && prestate == 0) {
    ...
    if (message2 == true) {
      ...
      if (count_value == 6  && r5 == false && g5 == false) {
        if (g6 == true && r6 == false) {
          digitalWrite(4, HIGH);
          delay(200);
          digitalWrite(4, LOW);
        }
        else if (r6 == true && g6 == false) {
          digitalWrite(6, HIGH);
          delay(200);
          digitalWrite(6, LOW);
        }  
  ...
  //push button 2 --
    ...
    if (pos == 0) {
    ...
    else if ((pos == 1) && (r1 == false) && (g1 == false)) {
      ...
      else if ((greenred == true) && (r1 == false)) {
        digitalWrite(12, HIGH);
        delay(10); // Delay a little bit to improve simulation performance
        greenred = false;
        g1 = true;
